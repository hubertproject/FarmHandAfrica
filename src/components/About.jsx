      ...
      <div className="container mx-auto flex flex-wrap items-center">
        <div className="w-full lg:w-1/2 lg:pr-8">
          ...
          <p className="text-white text-xl font-aclonica mb-10 text-left">
            ...
            burden of recruitment. We recognize the pivotal role skilled
            laborers play in farm success, hence our mission to streamline the
            process for the farmers. With FarmHand, managing laborers is
            effortless, allowing farmers to focus on optimizing farm operations.
          </p>
        </div>
