            ...
            <div className="min-h-[60vh] flex flex-col md:flex-row md:justify-between items-center md:mx-5 mx-5 mt-10">
              <div className="md:w-2/4 text-left rounded-lg p-2">
                ...
                <p className="mt-10 text-start text-2xlg font-bold font-quicksand  text-white">
                  At FarmHand, we believe in cultivating connections that
                  empower agriculture. Our platform serves as the fertile ground
                  where farmers and skilled labourers come together to sow the
                  seeds of success. Welcome to a revolutionary way of building
                  agricultural teams. Register to get connected to over 100
                  skilled Labourers in our Community.
                </p>
